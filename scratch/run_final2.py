...
def test_scenario(scenario_id, patient_id, form_data):
    ...
    """
    call_daemon(session, "evaluate", {"code": js_patient})
    time.sleep(2) # wait for patient load
    ...
    time.sleep(2) # wait for all inputs to process
    ...
    # WAIT 5 SECONDS for backend validation response!
    time.sleep(5)
